        ...
        try {
            ...
            await messageMutex.mutex(async () => {
                ...
                if (msg.key.participant && isLidUser(msg.key.participant)) {
                    msg.key.participant = resolveAnyLidToJid(msg.key.participant);
                }
                if (msg.key.remoteJid && isLidUser(msg.key.remoteJid)) {
                    msg.key.remoteJid = resolveAnyLidToJid(msg.key.remoteJid);
                }
