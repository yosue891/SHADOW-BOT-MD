...
const fishingRod = {
  basicrod: { name: "Basic Fishing Rod", luck: 0, speed: 0, comboFish: 1, comboMutations: 1, mutationsLuck: 0, sellMultiplier: 0, price: 0, description: "Caña estándar para principiantes.", level: 1, maxLevel: 5, exp: 0, expToNextLevel: 100 },
  ironrod: { name: "Iron Rod", luck: 0.02, speed: 0.03, comboFish: 1, comboMutations: 1, mutationsLuck: 0.001, sellMultiplier: 0.05, price: 25000, description: "Caña de hierro más resistente.", level: 1, maxLevel: 10, exp: 0, expToNextLevel: 100 },
  goldrod: { name: "Gold Rod", luck: 0.06, speed: 0.07, comboFish: 1, comboMutations: 1, mutationsLuck: 0.003, sellMultiplier: 0.15, price: 250000, description: "Caña de oro con mayor suerte.", level: 1, maxLevel: 15, exp: 0, expToNextLevel: 100 },
  diamondrod: { name: "Diamond Rod", luck: 0.12, speed: 0.13, comboFish: 2, comboMutations: 1, mutationsLuck: 0.007, sellMultiplier: 0.30, price: 2500000, description: "Caña de diamante — combo de peces mejorado.", level: 1, maxLevel: 20, exp: 0, expToNextLevel: 100 },
  ancientrod: { name: "Ancient Rod", luck: 0.20, speed: 0.20, comboFish: 2, comboMutations: 2, mutationsLuck: 0.015, sellMultiplier: 0.50, price: 25000000, description: "Caña antigua — mutaciones de combo mejoradas.", level: 1, maxLevel: 25, exp: 0, expToNextLevel: 100 },
  mythicrod: { name: "Mythic Rod", luck: 0.30, speed: 0.28, comboFish: 3, comboMutations: 2, mutationsLuck: 0.025, sellMultiplier: 0.75, price: 250000000, description: "Caña mítica — atrae peces raros.", level: 1, maxLevel: 30, exp: 0, expToNextLevel: 100 },
  legendaryrod: { name: "Legendary Rod", luck: 0.42, speed: 0.38, comboFish: 3, comboMutations: 3, mutationsLuck: 0.040, sellMultiplier: 1.00, price: 2500000000, description: "Caña legendaria — combo completo y gran bonificación de venta.", level: 1, maxLevel: 40, exp: 0, expToNextLevel: 100 },
  depthseekerrod: { name: "Depthseeker Rod", luck: 0.55, speed: 0.48, comboFish: 4, comboMutations: 3, mutationsLuck: 0.060, sellMultiplier: 1.30, price: 25000000000, description: "Caña de explorador del océano profundo.", level: 1, maxLevel: 50, exp: 0, expToNextLevel: 100 },
  voidrod: { name: "Void Rod", luck: 0.70, speed: 0.60, comboFish: 4, comboMutations: 4, mutationsLuck: 0.085, sellMultiplier: 1.75, price: 0, description: "Caña del vacío — de otra dimensión. (Tienda de tokens)", level: 1, maxLevel: 60, exp: 0, expToNextLevel: 100 },
  cosmicrod: { name: "Cosmic Rod", luck: 0.85, speed: 0.72, comboFish: 5, comboMutations: 4, mutationsLuck: 0.115, sellMultiplier: 2.20, price: 0, description: "Caña cósmica — poder de las estrellas. (Tienda de tokens)", level: 1, maxLevel: 75, exp: 0, expToNextLevel: 100 },
  prestigerod: { name: "Prestige Rod", luck: 0.95, speed: 0.80, comboFish: 5, comboMutations: 5, mutationsLuck: 0.150, sellMultiplier: 2.70, price: 0, description: "Caña de prestigio — recompensa para quienes superan los límites.", level: 1, maxLevel: 99, exp: 0, expToNextLevel: 100 },
  omegaRod: { name: "Omega Rod", luck: 1.20, speed: 0.90, comboFish: 6, comboMutations: 5, mutationsLuck: 0.200, sellMultiplier: 3.50, price: 0, description: "Caña omega — perteneciente al campeón de temporada.", level: 1, maxLevel: 99, exp: 0, expToNextLevel: 100 },
}

const rodEnchants = {
  swift: { name: "Swift", rarity: "common", effect: { progressSpeed: 1.05 }, desc: "Acelera el progreso de captura." },
  hasty: { name: "Hasty", rarity: "common", effect: { progressSpeed: 1.1 }, desc: "Aumenta la velocidad del progreso." },
  blessedsong: { name: "Blessed Song", rarity: "common", effect: { progressSpeed: 1.4 }, desc: "+40% Progress Speed" },
  patient: { name: "Patient", rarity: "common", effect: { luck: 1.05 }, desc: "La paciencia produce mejores resultados." },
  skilled: { name: "Skilled", rarity: "common", effect: { xpMultiplier: 1.25 }, desc: "XP adicional por cada captura." },
  divine: { name: "Divine", rarity: "rare", effect: { luck: 1.45 }, desc: "Suerte alta." },
  clever: { name: "Clever", rarity: "rare", effect: { xpMultiplier: 2.25 }, desc: "x2.25 XP" },
  frostbite: { name: "Frostbite", rarity: "rare", effect: { luck: 1.35 }, desc: "El frío del hielo calma a los peces." },
  lucky: { name: "Lucky", rarity: "epic", effect: { luck: 1.2 }, desc: "Aumenta la suerte." },
  volcanic: { name: "Volcanic", rarity: "epic", effect: { luck: 1.7, sellMultiplier: 1.6 }, desc: "El calor del magma aumenta el valor del pez." },
  glittered: { name: "Glittered", rarity: "epic", effect: { mutationChance: 0.03 }, desc: "Probabilidad de mutación +3%" },
  ...
  royalcrest: { name: "Royal Crest", rarity: "legendary", effect: { luck: 2.0, sellMultiplier: 2.5 }, desc: "Símbolo del rey del mar, valor y suerte extraordinarios." },
  crystalwave: { name: "Crystal Wave", rarity: "legendary", effect: { luck: 1.85, progressSpeed: 1.4, mutationChance: 0.04 }, desc: "Ola de cristal, resultados raros y rápidos." },
  seaoverlord: { name: "Sea Overlord", rarity: "legendary", effect: { fishSize: 6, sellMultiplier: 4 }, desc: "+300% Fish Size, 4x Sell" },
  phantom: { name: "Phantom", rarity: "legendary", effect: { luck: 1.8, mutationChance: 0.05 }, desc: "Energía del espíritu del mar, suerte y mutaciones raras." },
  chaotic: { name: "Chaotic", rarity: "mythic", effect: { sellMultiplier: 24 }, desc: "Valor de venta de peces drástico." },
  ...
  abyssborn: { name: "Abyssborn", rarity: "mythic", effect: { luck: 2.2, mutationChance: 0.12, sellMultiplier: 4 }, desc: "Poder del océano profundo." },
  astral: { name: "Astral", rarity: "mythic", effect: { luck: 2.5, progressSpeed: 1.4 }, desc: "Poder cósmico de las estrellas." },
  abyssalflare: { name: "Abyssal Flare", rarity: "godly", effect: { luck: 4.5, mutationChance: 0.25, sellMultiplier: 9 }, desc: "Fuego del abismo marino." },
  reapersnet: { name: "Reaper's Net", rarity: "godly", effect: { luck: 4.0, progressSpeed: 2.0, sellMultiplier: 7 }, desc: "Red segadora del mar." },
  timeless: { name: "Timeless", rarity: "secret", effect: { luck: 5.0, progressSpeed: 2.0, xpMultiplier: 3 }, desc: "La energía del tiempo te guía." },
  voidheart: { name: "Voidheart", rarity: "secret", effect: { luck: 6.0, mutationChance: 0.25, sellMultiplier: 12 }, desc: "Núcleo del vacío, mutación y valor extremo." },
  godslayer: { name: "Godslayer", rarity: "secret", effect: { luck: 7.5, progressSpeed: 2.5, sellMultiplier: 20, mutationChance: 0.35 }, desc: "Caña legendaria que desafía a los dioses del mar." },
  universe: { name: "Universe", rarity: "secret", effect: { luck: 8.5, mutationChance: 0.45, sellMultiplier: 24 }, desc: "Caña que facilita obtener peces secretos." },
  apocalypse: { name: "Apocalypse", rarity: "secret", effect: { luck: 9.0, sellMultiplier: 28, mutationChance: 0.5, fishSize: 4 }, desc: "Poder del fin de los tiempos." },
}
